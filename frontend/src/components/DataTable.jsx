...
import downloadComponentInPDF from "./DownloadComponent";
...
const DataTable = ({ columns, data, editItem, deleteItem }) => {
	...
	const downloadPDF = () => {
		const component = document.getElementById("data_to_print");
		...
		<div>
			<div className="flex items-center justify-between mb-6 w-full">
				<div className="w-2/3 flex items-center gap-5">
					<label
						htmlFor="search"
						className="max-w-[90%] origin-[0_0] pt-[0.37rem] leading-[1.6] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[0.9rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-200 dark:peer-focus:text-primary">
						Search
					</label>
					<input
						type="search"
			...
			<table id="data_to_print" className="w-full py-4">
				<thead>
